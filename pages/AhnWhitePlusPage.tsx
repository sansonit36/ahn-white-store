...
const { addToCart, products, pixelConfig, isLoading, reviews } = useShop(); // Added reviews
...
const handleAddToCart = () => {
    ...
    // TikTok Pixel with simple safety check
    if ((window as any).ttq) {
            ...
            <div className="grid lg:grid-cols-2 gap-8 md:gap-12 mb-12 md:mb-20">
                ...
                <div className="flex flex-col">
                    <div className="flex items-center gap-2 mb-2">
                        ...
                        <span className="text-xs md:text-sm text-gray-500 underline decoration-gray-300 underline-offset-4">{reviews.length} Reviews</span>
                    </div>
